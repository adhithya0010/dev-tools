...
public class TextUtils {
  ...
  static {
    ESCAPER.put(
        "csv", new EscapeUnescape(StringEscapeUtils::unescapeCsv, StringEscapeUtils::escapeCsv));
    ESCAPER.put(
        "html",
        new EscapeUnescape(StringEscapeUtils::escapeHtml4, StringEscapeUtils::unescapeHtml4));
    ESCAPER.put(
        "java", new EscapeUnescape(StringEscapeUtils::escapeJava, StringEscapeUtils::unescapeJava));
    ESCAPER.put(
        "javascript",
        new EscapeUnescape(
            StringEscapeUtils::escapeEcmaScript, StringEscapeUtils::unescapeEcmaScript));
    ESCAPER.put(
        "xml", new EscapeUnescape(StringEscapeUtils::escapeXml11, StringEscapeUtils::unescapeXml));
  }
